                ...
                <div class="message-listing" id="messageWrapper">
                    <div class="row message align-items-center mb-2">
                        <div class="col-md-12 user-info">
                            ...
                            <div class="chat-name font-weight-bold">
                                amir javadi
                                <span class="small time text-gray" title="2023-05-02 10:30 PM">
                                    10:30 PM
                                </span>
                            </div>
                        </div>
        ...
        $(function (){
            ...
            function appendMessageToSender(message){
                ...
                let userInfo =
                    ...
                    '<div class="chat-name font-weight-bold">\n'+
                    name +
                    '<span class="small time text-gray" title="'+getCurrentDateTime()+'">\n'+
                     getCurrentDateTime() +
                    '</span>\n'+
                    '</div>\n'+
                    '</div>\n';
            ...
            function appendMessageToReceiver(message){
                ...
                let userInfo =
                    ...
                    '<div class="chat-name font-weight-bold">\n'+
                    name +
                    '<span class="small time text-gray" title="'+dateFormat(message.created_at)+'">\n'+
